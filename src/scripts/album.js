...
album.delete = function (albumIDs) {
  ...
  if (albumIDs.toString() === '0') {
    ...
    msg = lychee
      .html`<p>Are you sure you want to delete the album '$${ albumTitle }' and all of the photos it contains? This action can't be undone!</p>`
    ...
    msg = lychee
      .html`<p>Are you sure you want to delete all $${ albumIDs.length } selected albums and all of the photos they contain? This action can't be undone!</p>`
...
album.setDescription = function (albumID) {
  ...
  basicModal.show({
    body: lychee
      .html`<p>Please enter a description for this album: <input class='text' name='description' type='text' maxlength='800' placeholder='Description' value='$${ oldDescription }'></p>`,
    buttons: {
      action: {
