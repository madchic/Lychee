  ...
  api.post('Albums::get', {}, function (data) {
    ...
    if (data.albums && data.num > 1) {
      ...
      $.each(data.albums, function () {
        ...
        let html = lychee
          .html`<img class='cover' width='16' height='16' src='$${ this.thumbs[0] }'><div class='title'>$${ this.title }</div>`
...
contextMenu.photoTitle = function (albumID, photoID, e) {
  ...
  if (data.content !== false && data.num > 1) {
    ...
    $.each(data.content, function (index) {
      ...
      let html = lychee
        .html`<img class='cover' width='16' height='16' src='$${ this.thumbUrl }'><div class='title'>$${ this.title }</div>`
...
contextMenu.photoMore = function (photoID, e) {
  ...
  let showDownload = lychee.publicMode === false || ((album.json && album.json.downloadable && album.json.downloadable === '1') && lychee
    .publicMode === true)
